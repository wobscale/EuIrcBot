...
module.exports.commands = {
  "btc": function(remainder, parts, reply, command, from, to, text, raw) {
  ...
  "ltc": function(remainder, parts, reply, command, from, to, text, raw) {
    btce.ticker({pair: "ltc_usd"}, function(err, data) {
      if(err || !data || !data.ticker) return reply("Error occured getting BTC prices");
      data = data.ticker;
      if(data[remainder.toLowerCase()]) {
        reply(remainder + ":", data[remainder.toLowerCase()]);
